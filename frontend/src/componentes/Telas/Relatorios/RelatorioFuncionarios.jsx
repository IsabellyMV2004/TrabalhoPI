                                            ...
                                            <td>
                                                <Button 
                                                    ...
                                                    to={{
                                                        ...
                                                        state: { nome: funcionario.nome, cpf: funcionario.cpf, cargo: funcionario.cargo, nivel: funcionario.nivel, email: funcionario.email, senha: funcionario.senha}}}variant="warning">
